...
<body>
	...
	<div class="main">
		<div class="container">
			...
			<hr>
			${message}
			<form:form action="admin/ad/delete.htm" modelAttribute="ad">
				<div class="form-group">
					<label class="kc">Mã quảng cáo</label>
					<br>
			...
			<br>
			<a href="admin/ad/index.htm" class="btn btn-info btn-sm" role="button" style="width: 500px;">Hủy</a>
			<hr>
		</div>
	</div>
